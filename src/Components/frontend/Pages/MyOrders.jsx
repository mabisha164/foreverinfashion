      ...
      <div className="flex justify-around shadow-2xl w-full ">
        ...
        <div className="w-[350px] bg-gray-100 p-4  h-[550px] rounded-lg ">
          ...
          <div className="mb-4 flex">
            <CgCreditCard size={20} color="green" className="mt-1 mr-1" />
...
//       if (data.success) {
//         console.log("Setting order data:", data.order_data);
//         setOrderData(data.order_data);
//       } else {
//         console.log("Error fetching orders:", data.error);
//       }
...
//       let total = 0;
//       orderData?.forEach((order) => {
//         total += (parseInt(order.price) || 0) * (order.quantity || 1);
//       });

//       return total;
//     } catch (error) {
//       console.log("Error calculating total price:", error);
//       return 0; // Return a default value to prevent NaN
//     }
//   };
...
//                   <td className="py-2 px-4">{order.name}</td>
//                   <td className="py-2 px-4 text-right">
//                     Rs.{(parseInt(order.price) || 0) * (order.quantity || 1)}
//                   </td>
//                 </tr>
//               ))}
//               <tr className="border-t border-gray-200">
...
//           </h2>
//           <div className="mb-4 flex">
// <CgCreditCard size={20} color="green" className="mt-1 " />
//             <label className="block text-gray-700 font-bold ml-2">
//               Credit Card
//             </label>
//           </div>
//           <div className="mb-4 flex">

...
const Description = ({ addToCart }) => {
  ...
  return (
    <div className="ml-36">
      ...
      <div className="flex mt-10 bg-blue-100 w-[80%] ml-16 rounded-2xl shadow-2xl">
        <div className="flex ">
          <br />
          <div className=" my-2   border-2  border-white rounded-2xl shadow-2xl w-[450px] ml-16">
            <img className="w-[450px]  rounded-xl  " src={img} alt={name} />
          </div>
        </div>
        <div className="">
          ...
          <div>
            ...
            >
              <div className="relative top-0 flex justify-center items-center text-center mt-24 text-white hover:bg-orange-300 hover:text-white bg-red-500 w-[200px] h-[50px] text-xl  shadow-2xl rounded-lg font-cursive ml-16">
